            ...
            <section className='section-container_header'>
                <div className='section-banner_info'>
                    ...
                    <h2>
                        ...
                        <span className='text_phone' onClick={() => { handleWhatsapp('+5547991566155') }}>
                            47 9 9156-6155
                        </span>
                    </h2>
                    <h2 className='text_help' onClick={() => { handleHelp() }}>Precisa de Ajuda?</h2>
                </div>
                <div className='section-container_header_content'>
                    ...
                    <div className='section-header_content'>
                        <button className='btn_search-bar_search' onClick={handleSearchSubmit}>
                            <span className="fa-solid fa-magnifying-glass" />
                        </button>
                        <input type="text" className={search ? 'search-bar' : 'search-bar'} maxLength={100} value={search} placeholder='O que você procura na Tintas Fischer?' onChange={handleSearchInputChange} onKeyDown={handleEnterPress} onClick={handleShowHistory} onMouseLeave={handleCloseHistory} />
                    ...
                    <div className='section_socialmedia'>
                        <span className="fa-brands fa-instagram" onClick={() => { handleSocialMedia('https://www.instagram.com/tintasfischer/') }} />
                        <span className="fa-brands fa-square-facebook" onClick={() => { handleSocialMedia('https://www.facebook.com/lojatintasfischer/about/') }} />
                    </div>
                </div>
                    ...
                    <div className='section-menu_content'>
                        ...
                        {scroll && (
                            <ul data-aos='fade-right' data-aos-offset='50' data-aos-duration='1500'>
                                ...
                                <li className='li_2'><Link to='/sobre' className='link'>Sobre</Link></li>
                                <li className='li_3'><Link to='/produtos' className='link'>Produtos</Link></li>
                                <li className='li_4'><Link to='/cores-inspiracoes' className='link'>Cores e Inspirações</Link></li>
                                <li className='li_5'><Link to='/assistencia' className='link'>Assistência</Link></li>
                                <li className='li_6'><Link to='/contato' className='link_contact'>Contato</Link></li>
                            </ul>
                        )}
                    </div>
                </section>
